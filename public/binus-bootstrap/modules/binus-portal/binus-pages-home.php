		...
		<div class="main-content bg-gray" id="main-content">
			<div class="container">
						...
						<form action="#" method="get" class="form-simple-search">
							<p>
								<span class="custom-search">
									<input type="text" name="input[]" placeholder="Type on this field and hit Enter/Return to search for BINUS Employee">
				...
				<div class="prtl-lecturers open-container" id="lecturers">
					<div class="container">
                        <h1 class="heading text-color">Most Search Employee</h1>
