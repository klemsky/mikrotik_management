						...
						<table class="bordered">
							...
							<tbody>
								<tr>
									...
									<td rowspan="2"><a href="auditor-audit-detail.php" class="icon icon-ami-arrow-right"></a></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>Lorem ipsum dolor sit amet.</td>
									<td><i class="icon icon-ami-checklist"></i></td>
									<td rowspan="3"><a href="auditor-audit-detail.php" class="icon icon-ami-arrow-right"></a></td>
								</tr>
								<tr>
									<td>2. Lorem ipsum dolor sit amet.</td>
									<td>Lorem ipsum dolor sit amet.</td>
