					...
					<div class="table-component">
						...
						<div class="item-table">
							...
							<div class="item-body">
								<table class="zebra bordered horizontal">
									<tbody>
										<tr>
											...
											<td class="with-action">Opportunity for Improvement</td>
											<td class="action">
												<a href="auditor-audit-form-edit.php #target-id" class="icon icon-edit has-tooltip fancybox-trigger fancybox.ajax" title="Edit Data"></a>
											</td>
										</tr>
										<tr>
											<th>Sebab</th>
											<td class="with-action">Lain-lain</td>
											<td class="action">
												<a href="auditor-audit-form-edit.php #target-id-2" class="icon icon-edit has-tooltip fancybox-trigger fancybox.ajax" title="Edit Data"></a>
											</td>
										</tr>
										<tr>
											<th>Uraian Temuan</th>
											<td class="with-action">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</td>
											<td class="action">
												<a href="auditor-audit-form-edit.php #target-id-3" class="icon icon-edit has-tooltip fancybox-trigger fancybox.ajax" title="Edit Data"></a>
											</td>
										</tr>
										<tr>
											<th>Rencana Tenggat Perbaikan</th>
											<td colspan="2">11 Desember 2014</td>
										</tr>
										<tr>
											<th>Perbaikan</th>
								...
								<span class="item-action">
									<a href="auditor-audit-verified.php #target-id" class="fancybox-trigger fancybox.ajax">Verifikasi Perbaikan</a>
								</span>
							</div>
						</div>
						<div class="add-data-container">
							<a href="auditor-audit-form-add.php #target-id" class="button button-primary with-icon icon-btn-add fancybox-trigger fancybox.ajax">
								Tambah Temuan
							</a>
						</div>
					</div>
