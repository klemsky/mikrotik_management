		...
		<div class="main-content has-widget" id="main-content">
			<div class="container">
				<div class="box-container">
					...
					<div class="single-content popup-content" id="target-id-8">
						<h1 class="heading new-layout">Edit Data</h1>
						<form action="#" method="post">
							<p>
								<label>Bagian</label>
								<span class="custom-combobox">
									<select name="input[]">
										<option value="1">Select Bagian</option>
									</select>
								</span>
							</p>
							<p align="right" class="action">
					...
					<div class="single-content popup-content" id="target-id-9">
						<h1 class="heading new-layout">Edit Data</h1>
						<form action="#" method="post">
							<p>
								<label>Sub Bagian</label>
								<span class="custom-combobox">
									<select name="input[]">
										<option value="1">Select Sub Bagian</option>
									</select>
								</span>
							</p>
							<p align="right" class="action">
					...
					<div class="single-content popup-content" id="target-id-10">
						<h1 class="heading new-layout">Edit Data</h1>
						<form action="#" method="post">
							<p>
								<label>Jadwal Audit</label>
					...
					<div class="single-content popup-content" id="target-id-11">
						<h1 class="heading new-layout">Edit Data</h1>
						<form action="#" method="post">
					...
					<div class="single-content popup-content" id="target-id-12">
						<h1 class="heading new-layout">Edit Data</h1>
						<form action="#" method="post">
							<div class="multiple-component">
								<label>Auditee</label>
